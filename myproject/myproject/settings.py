...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-n2)8suj44q8-1@b8n=3&6g1j90#3^b4*)^3vps)y$qgjq!m44@')
...
# This production setting is needed for Heroku/Render to serve static files
if not DEBUG:
